...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (File.Exists(Application.dataPath + FILE_ALL_SCORES)) //if the high score file exists
        {
            string fileContents = File.ReadAllText(Application.dataPath + FILE_ALL_SCORES); //get the contents of the file
    ...
    public void UpdateHighScores()
    {
        ...
        File.WriteAllText(Application.dataPath + FILE_ALL_SCORES, fileContents); //save the list to the file
    }
